...
<body>
  ...
  <hr style="width: 14rem;">
   <br>
        <br>
    <form name="Upload" action="pro_diet_write_ok.php" method="post" >
      <div id="container_diet_input" >

    
            <input class="diary_title" type = "text" name="morning" placeholder = "아침">
            <br>
            <input class="diary_title" type = "text" name="lunch" placeholder = "점심">
            <br>
            <input class="diary_title" type = "text" name="dinner" placeholder = "저녁">  
      </div>    
